...
export const leadService = {
  ...
  updateInstallment: async (
    id,
    index,
    { file, files, removeProofUrls, remarks, amount, receivedAmount, mode, qrCode, transactionId, upiId, scheduledAt },
  ) => {
    ...
    if (qrCode?.trim()) formData.append('qr_code', qrCode.trim())
