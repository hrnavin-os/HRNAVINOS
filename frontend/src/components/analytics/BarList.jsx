...
export function BarList({
  ...
  limit = 8,
  emptyLabel = 'Not set',
  // Off for a scale that already has an order of its own - the waiting
  // buckets run 0-3 days to 15+, and sorting them by size would turn a ramp
  // into a ranking that reads backwards.
  sorted = true,
}) {
