...
import { Calendar, CheckCircle2, CreditCard, Layers, Phone, Wallet, XCircle } from 'lucide-react'
...
const INFO_ITEMS = (lead) => [
  ...
  { icon: Layers, label: 'Batch', value: lead.batch_preference ?? '—' },
  { icon: Wallet, label: 'Amount', value: lead.paid_amount ? formatCurrency(lead.paid_amount) : '—' },
  { icon: CreditCard, label: 'Mode', value: lead.payment_mode ? titleCase(lead.payment_mode) : '—' },
]
      ...
      <div className="-mt-2 space-y-4">
        ...
        {lead.payment_image_url && (
          <div>
            ...
            <img
              src={`${MEDIA_BASE_URL}${lead.payment_image_url}`}
              alt="Payment proof"
