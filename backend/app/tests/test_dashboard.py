...
def test_dashboard_overview_reflects_created_data(client, auth_headers):
    client.post(
        "/api/v1/courses",
        headers=auth_headers,
        json={"name": "Full Stack Development", "code": "FSD-01", "duration_weeks": 12, "fee": "25000.00"},
    )
    client.post("/api/v1/leads", headers=auth_headers, json={"name": "Ravi Kumar", "phone": "9876543210"})
