...
async def create_batch(
    ...
    return BatchResponse.model_validate(await BatchService().create(payload, actor_id=actor.id))
...
async def list_batches(
    ...
    result = await BatchService().list(params, course_id=course_id)
...
async def get_batch(
    ...
    return BatchResponse.model_validate(await BatchService().get(batch_id))
...
async def update_batch(
    ...
    return BatchResponse.model_validate(await BatchService().update(batch_id, payload, actor_id=actor.id))
...
async def delete_batch(
    ...
    await BatchService().delete(batch_id, actor_id=actor.id)
