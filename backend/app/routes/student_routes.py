...
async def create_student(
    ...
    return StudentResponse.model_validate(await StudentService().create(payload, actor_id=actor.id))
...
async def list_students(
    ...
    result = await StudentService().list(params, batch_id=batch_id)
...
async def get_student(
    ...
    return StudentResponse.model_validate(await StudentService().get(student_id))
...
async def update_student(
    ...
    return StudentResponse.model_validate(await StudentService().update(student_id, payload, actor_id=actor.id))
...
async def delete_student(
    ...
    await StudentService().delete(student_id, actor_id=actor.id)
